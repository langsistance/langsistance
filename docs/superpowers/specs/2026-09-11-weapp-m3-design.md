...
- `Taro.useShareAppMessage` → 转发给好友，~~卡片标题取当前提问/会话标题~~ → **2026-09-15 推翻**：标题与配图固定为品牌，见 `2026-09-15-weapp-landing-share-design.md` §2，`path` 指向首页
...
> **2026-09-15 注记**：本节关于「卡片标题取当前提问/会话标题」的原始设计已被推翻。原因有二：会话标题就是用户首问原文，会随转发卡片外泄给好友与朋友圈；且未设 `imageUrl` 时微信会回退到页面截图，同样可能带出会话内容。现行做法是标题与配图都固定为品牌，见 `2026-09-15-weapp-landing-share-design.md` §2。
...
7. ~~转发卡片标题带当前提问/会话标题~~ → **2026-09-15 推翻**：标题与配图固定为品牌，见 `2026-09-15-weapp-landing-share-design.md` §2
8. 小程序内可访问中文隐私政策页
