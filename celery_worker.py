...
# `_uspto_get_with_retry` and `_download_uspto_spec_with_redirect` moved to the
# shared module sources.long_task.uspto_download.  `_uspto_get_with_retry` is
# still referenced elsewhere in this file (prosecution / vision download paths),
# so keep a forwarding alias; `_download_uspto_spec_with_redirect` had no other
# callers and is fully removed.
from sources.long_task import uspto_download as _uspto_download_module

_uspto_get_with_retry = _uspto_download_module._uspto_get_with_retry
