...
export default {
  ...
  chat: {
    ...
    attachFiles: 'Attach patent files (PDF, DOCX, XML) or product images (JPG, PNG, WEBP)',
    dropFilesHere: 'Drop patent files or product images here',
    ...
    landing: {
      ...
      cap3Desc: 'Auto-trace office actions and arguments into a timeline',
      cap4Title: 'Cross-Border Family Prosecution Analysis',
      cap4Desc: 'Family layout and per-country prosecution in one view',
