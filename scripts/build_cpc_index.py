...
MCF text layout (fixed-width, one record per line):
  ...
  B <patent 5-9 digits><8-digit record index><CPC symbol> <version> 0 0
...
def _parse_mcf_line(line: str):
    ...
    None for A records and anything unparseable.  Never raises.
    """
