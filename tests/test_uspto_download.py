...
# New shared-module tests (sources.long_task.uspto_download) — added by the
# chat-patent-analysis extraction task.  Kept here alongside the original
# sources.uspto_download tests so both modules stay covered under one filename.
